...
CertHub.register({
  ...
  status: "check",
  statusNote: "Domains and weights follow the updated CC outline effective Sept 1, 2026 (Security Principles 24%, Security Governance 17.3%, IAM Concepts 20%, Networking and Cloud Security Concepts 21.3%, Security Operations and Incident Response 17.3%; rounded here to whole percents). They come from summaries of ISC2's Aug 2026 announcement, not from the official outline page itself, so confirm against ISC2's current outline.",
