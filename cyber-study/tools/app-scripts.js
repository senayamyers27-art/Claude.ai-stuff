...
module.exports = function appScripts(certIds) {
  ...
  return {
    labFiles,
    scripts: ["assets/core.js", "data/site.js", "data/catalog.js", "data/lab-map.js", ...certIds.map(id => `data/${id}.js`), ...labFiles.map(f => `data/${f}`), "assets/engine.js", "assets/labs.js", "assets/pages.js", "assets/sync.js", "assets/app.js"]
  };
};
